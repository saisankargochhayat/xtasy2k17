...
var templateBaseURL         = "https://xtasy.cetb.in/";/*"http://themes.mediacreed.com/html/synergy/"*/
...
$(window).load(function(){
	readyAndLoad++;
    if(templateBaseURL == "xtasy.cetb.in" || templateBaseURL == "null"){
...
/* end GENERAL JS PROPERTIES */
 ...
 /*================= GENERAL  TXT NAMES ==========================*/
	...
	function slideshowShowThumbs(){
        ...
        thumbsHolder.attr("style", "margin-left:" + val + "px; bottom: -84px;");
        if(touchDevice == 1){
